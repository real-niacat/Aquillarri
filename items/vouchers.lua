SMODS.Voucher {
    ...
    get_emult = function(self, card)
        local d = 0.05
        return to_big(G.GAME.dormant_exponent+d):pow(card.ability.extra.exponent) - d
    end
}
...
SMODS.Voucher {
    ...
    redeem = function(self, voucher)
        ...
        -- code in p_utils.lua : aquill.calc_dormant_blind_size
    end
}
