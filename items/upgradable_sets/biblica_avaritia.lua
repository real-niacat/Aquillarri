aquill.Upgradable {
    ...
    calculate = function(self, card, context)
        if context.end_of_round and context.main_eval and (G.GAME.dollars >= card.ability.extra.spend) then
...
aquill.Upgradable {
    ...
    config = { extra = { spend = 3, percent = 2 } },
}
...
aquill.Upgradable {
    ...
    config = { extra = { spend = 2, percent = 5 } },
}